...
#ifdef ADDMAC
    unsigned char *pseudo_rr = NULL;
    if (edns0_get_opt_rr(msg, len, &pseudo_rr) == 0){
      /* pseudo_rr now points the rdlength of a psuedo_rr */
      edns0_add_client_mac(pseudo_rr, len, fromaddrp);
    }
#endif /* ADDMAC */
